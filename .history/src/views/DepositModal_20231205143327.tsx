...
export const DepositeModal = ({
	...
	useEffect(() => {
		if (transactionState.type === "waitingForConfirmation" && transactionState.tx?.rawSentTransaction) {
			console.debug("transactionState =", transactionState.type, transactionState.tx.rawSentTransaction)
			const tx=transactionState.tx.rawSentTransaction as unknown as string;
			onDone(tx);
		}
