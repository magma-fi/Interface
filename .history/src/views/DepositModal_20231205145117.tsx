...
import { TransactionResolvedWaitingForConfirmations, useMyTransactionState } from "../components/Transaction";
...
export const DepositeModal = ({
	...
	useEffect(() => {
		if (transactionState.type === "waitingForConfirmation" && transactionState.tx?.rawSentTransaction) {
			...
			(transactionState as TransactionResolvedWaitingForConfirmations).resolved = true;
		}
