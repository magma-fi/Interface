...
export const DepositeModal = ({
	...
	useEffect(() => {
		if (transactionState.type === "waitingForConfirmation" && transactionState.tx?.rawSentTransaction) {
			onDone(transactionState.tx.rawSentTransaction.hash);
		}
	}, [transactionState.type])
	console.debug("transactionState =", transactionState.type, transactionState.tx && transactionState.tx.rawSentTransaction?.hash, transactionState)
