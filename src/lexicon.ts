...
export const BORROW_FEE: Lexicon = {
  term: "Borrowing Fee",
  description:
    "The Borrowing Fee is a one-off fee charged as a percentage of the borrowed amount (in WEN) and is part of a Trove's debt. The fee varies between 0.5% and 5% depending on WEN redemption volumes."
};
...
export const STABILITY_POOL_LUSD: Lexicon = {
  term: "WEN in Stability Pool",
  description:
    "The total WEN currently held in the Stability Pool, expressed as an amount and a fraction of the WEN supply."
};
...
export const LUSD_SUPPLY: Lexicon = {
  term: "WEN supply",
  description: "The total WEN minted by the Liquity Protocol."
};
