...
export const DepositeModal = ({
	...
	const newLiquidationPrice = (
		(depositAndBorrow && borrowValue > 0 && updatedTrove.collateral.gt(0))
		|| (!depositAndBorrow && updatedTrove.collateral.gt(0))
	) ? newDebtToLiquidate.mul(MCR).div(updatedTrove.collateral) : liquidationPrice;
